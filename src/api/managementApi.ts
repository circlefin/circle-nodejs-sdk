...
export class ManagementApi {
     ...
     */
    public async getConfig (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetConfigResponse;  }> {
        const localVarPath = this.basePath + '/v1/configuration';
