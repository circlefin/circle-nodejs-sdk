...
export const WiresApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getBusinessAccountWireInstructionsBankAccount: async (id: string, currency?: 'USD' | 'EUR', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const WiresApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getBusinessAccountWireBankAccounts(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetBusinessAccountWireBankAccountsResponse>> {
         ...
         * @throws {RequiredError}
         */
        async getBusinessAccountWireInstructionsBankAccount(id: string, currency?: 'USD' | 'EUR', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetBusinessAccountWireInstructionsBankAccountResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getBusinessAccountWireInstructionsBankAccount(id, currency, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const WiresApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getBusinessAccountWireBankAccounts(options?: any): AxiosPromise<GetBusinessAccountWireBankAccountsResponse> {
         ...
         * @throws {RequiredError}
         */
        getBusinessAccountWireInstructionsBankAccount(id: string, currency?: 'USD' | 'EUR', options?: any): AxiosPromise<GetBusinessAccountWireInstructionsBankAccountResponse> {
            return localVarFp.getBusinessAccountWireInstructionsBankAccount(id, currency, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get a Wire bank account
...
export class WiresApi extends BaseAPI {
     ...
     * @memberof WiresApi
     */
    public getBusinessAccountWireInstructionsBankAccount(id: string, currency?: 'USD' | 'EUR', options?: AxiosRequestConfig) {
        return WiresApiFp(this.configuration).getBusinessAccountWireInstructionsBankAccount(id, currency, options).then((request) => request(this.axios, this.basePath));
    }
