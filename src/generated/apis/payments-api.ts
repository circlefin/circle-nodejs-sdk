  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createSepaPayment(
          mockSepaPaymentRequest,
          options
        );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createWirePayment(
          mockWirePaymentRequest,
          options
        );
      return createRequestFunction(
    ...
    async getPayments(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<GetPaymentsResponse>
    > {
...
export const PaymentsApiFactory = function (
  ...
  return {
    ...
    createSepaPayment(
      ...
      return localVarFp
        .createSepaPayment(mockSepaPaymentRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * In the sandbox environment, initiate a mock wire payment that mimics the behavior of funds sent through the bank (wire) account linked to master wallet.
    ...
    createWirePayment(
      ...
      return localVarFp
        .createWirePayment(mockWirePaymentRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
