...
export const SENApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    createBusinessAccountSenBankAccount: async (
     ...
     * @throws {RequiredError}
     */
    getBusinessAccountSenBankAccount: async (
      id: string,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getBusinessAccountSenBankAccounts: async (
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      const localVarPath = `/v1/businessAccount/banks/sen`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getBusinessAccountSenInstructionsBankAccount: async (
      id: string,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
  ...
  return {
    ...
    async createBusinessAccountSenBankAccount(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<CreateBusinessAccountSenBankAccountResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createBusinessAccountSenBankAccount(
          senFiatAccountCreationRequest,
          options
        );
    ...
    async getBusinessAccountSenBankAccount(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<GetBusinessAccountSenBankAccountResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getBusinessAccountSenBankAccount(
          id,
          options
        );
      return createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getBusinessAccountSenBankAccounts(
      options?: AxiosRequestConfig
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<GetBusinessAccountSenBankAccountsResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getBusinessAccountSenBankAccounts(
          options
        );
      return createRequestFunction(
        localVarAxiosArgs,
     ...
     * @throws {RequiredError}
     */
    async getBusinessAccountSenInstructionsBankAccount(
      id: string,
      options?: AxiosRequestConfig
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<GetBusinessAccountSenInstructionsBankAccountResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getBusinessAccountSenInstructionsBankAccount(
          id,
          options
        );
      return createRequestFunction(
...
export const SENApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getBusinessAccountSenBankAccount(
      id: string,
      options?: any
    ): AxiosPromise<GetBusinessAccountSenBankAccountResponse> {
      return localVarFp
        .getBusinessAccountSenBankAccount(id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getBusinessAccountSenBankAccounts(
      ...
      return localVarFp
        .getBusinessAccountSenBankAccounts(options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get the Silvergate SEN transfer instructions into the Circle bank account given your bank account id (BETA).
    ...
    getBusinessAccountSenInstructionsBankAccount(
      ...
      return localVarFp
        .getBusinessAccountSenInstructionsBankAccount(id, options)
        .then((request) => request(axios, basePath));
    }
  };
};
...
export class SENApi extends BaseAPI {
   ...
   * @memberof SENApi
   */
  public createBusinessAccountSenBankAccount(
    senFiatAccountCreationRequest?: SenFiatAccountCreationRequest,
    options?: AxiosRequestConfig
  ) {
   ...
   * @memberof SENApi
   */
  public getBusinessAccountSenBankAccount(
    id: string,
    options?: AxiosRequestConfig
  ) {
    return SENApiFp(this.configuration)
   ...
   * @memberof SENApi
   */
  public getBusinessAccountSenInstructionsBankAccount(
    id: string,
    options?: AxiosRequestConfig
  ) {
    return SENApiFp(this.configuration)
