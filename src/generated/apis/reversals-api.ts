...
// @ts-ignore
import { ListReversalsResponse } from "../models";
// @ts-ignore
  ...
  return {
    ...
    async listReversals(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListReversalsResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listReversals(
        status,
        from,
        to,
        pageBefore,
