 ...
 * @export
 */
export const ChargebacksApiAxiosParamCreator = function (
  ...
  return {
    ...
    getChargeback: async (
      ...
      const localVarPath = `/v1/chargebacks/{id}`.replace(
        `{${"id"}}`,
...
export const ChargebacksApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    ChargebacksApiAxiosParamCreator(configuration);
  return {
    /**
     * In the sandbox environment, initiate a mock chargeback of a specified payment.  The entire payment will be charged back for its full value.  The payment must be in the `paid` state (otherwise the endpoint will return a `404`), and each payment can only be charged back once (otherwise the endpoint will return a `409`).  This endpoint is only available in the sandbox environment.
     * @summary Create a mock chargeback
    ...
    async createMockChargeback(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<CreateMockChargebackResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createMockChargeback(
          mockChargebackCreationRequest,
          options
        );
    ...
    async getChargeback(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<GetChargebackResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getChargeback(
        id,
        options
      );
      return createRequestFunction(
    ...
    async listChargebacks(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListChargebacksResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listChargebacks(
        paymentId,
        from,
        to,
        pageBefore,
 ...
 * @export
 */
export const ChargebacksApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
...
export class ChargebacksApi extends BaseAPI {
   ...
   */
  public createMockChargeback(
    mockChargebackCreationRequest?: MockChargebackCreationRequest,
    options?: AxiosRequestConfig
  ) {
    return ChargebacksApiFp(this.configuration)
      .createMockChargeback(mockChargebackCreationRequest, options)
