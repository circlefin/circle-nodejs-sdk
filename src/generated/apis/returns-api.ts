...
// @ts-ignore
import { ListReturnsResponse } from "../models";
// @ts-ignore
  ...
  return {
    ...
    async listReturns(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListReturnsResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listReturns(
        from,
        to,
        pageBefore,
        pageAfter,
...
export const ReturnsApiFactory = function (
  ...
  return {
    ...
    listReturns(
      ...
      return localVarFp
        .listReturns(from, to, pageBefore, pageAfter, pageSize, options)
