...
export const ACHApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createMockACHBankAccount: async (
...
export const ACHApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async createMockACHBankAccount(
      mockAchAccountCreationRequest?: MockAchAccountCreationRequest,
      options?: AxiosRequestConfig
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createMockACHBankAccount(
          mockAchAccountCreationRequest,
          options
        );
      return createRequestFunction(
...
export const ACHApiFactory = function (
  ...
  return {
    ...
    createMockACHBankAccount(
      ...
      return localVarFp
        .createMockACHBankAccount(mockAchAccountCreationRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export class ACHApi extends BaseAPI {
   ...
   * @memberof ACHApi
   */
  public createMockACHBankAccount(
    mockAchAccountCreationRequest?: MockAchAccountCreationRequest,
    options?: AxiosRequestConfig
  ) {
    return ACHApiFp(this.configuration)
